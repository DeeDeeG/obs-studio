...
#define TEXT_FRAMERATE_LIMIT_FPS    obs_module_text("GameCapture.FramerateLimitFPS")
#define TEXT_FRAMERATE_LIMIT_FPS_TT obs_module_text("GameCapture.FramerateLimitFPS.TT")
